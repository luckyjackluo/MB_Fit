#include "mbnrg_2b_A1B2X2_A1B2X2_deg4_v1.h"

////////////////////////////////////////////////////////////////////////////////

namespace mbnrg_A1B2X2_A1B2X2_deg4 {

mbnrg_A1B2X2_A1B2X2_deg4_v1::mbnrg_A1B2X2_A1B2X2_deg4_v1(const std::string mon1, const std::string mon2) {
...
//----------------------------------------------------------------------------//
 ...
 double mbnrg_A1B2X2_A1B2X2_deg4_v1::eval(const double *xyz1, const double *xyz2, const size_t n) {
    ...
    for (size_t j = 0; j < n; j++) {
        ...
        monomer m2;
        m2.setup(coords_A_1_b, w12, wcross, coords_X_1_b, coords_X_2_b);
...
double mbnrg_A1B2X2_A1B2X2_deg4_v1::eval(const double *xyz1, const double *xyz2, double *grad1, double *grad2 , const size_t n, std::vector<double> *virial) {
    std::vector<double> energies(n,0.0);
    std::vector<double> energies_sw(n,0.0);
    ...
    for (size_t j = 0; j < n; j++) {
        ...
        m2.grads(coords_X_1_b_g, coords_X_2_b_g, w12, wcross, coords_A_1_b_g);
